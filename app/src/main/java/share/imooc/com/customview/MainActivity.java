...
public class MainActivity extends AppCompatActivity implements View.OnClickListener,SaveImageLister{
    ...
    public void onSaveFinshed(String absolutePath) {
        Toast.makeText(this, "图片保存在："+absolutePath, Toast.LENGTH_SHORT).show();
    }
}
